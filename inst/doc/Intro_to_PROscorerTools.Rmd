...
3.  Expand PROscorer with more scoring functions for specific PROs.  I will have
to do this for my job anyway, but writing new scoring functions will also help
with programming #1 and #2 above.
...
GitHub page](https://github.com/raybaser/PROscorerTools/issues):
